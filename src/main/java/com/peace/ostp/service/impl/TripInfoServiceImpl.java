...
public class TripInfoServiceImpl implements ITripInfo {
	...
	//查询所有行程
	public List<TripTravelInfo> getTripInfosList(){
		return tripTravelInfoMapper.getTripInfosList();
	}
	...
	public int getTotalRecord() {
		...
		return tripTravelInfoMapper.getTotalRecord();
	}

	@Override
	public List<TripTravelInfo> getTripInfosList(Map<String, Object> map) {
		// TODO Auto-generated method stub
		return tripTravelInfoMapper.getTripInfosList();
	}
