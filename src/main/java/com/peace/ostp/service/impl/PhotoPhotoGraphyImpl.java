...
public class PhotoPhotoGraphyImpl implements IPhotoPhotoGraphy{
	...
	@Override
	public List<PhotoPhotoGraphy> getGroupPhotoGraphie(int index) {
		// TODO Auto-generated method stub
		return photophotographyMapper.getGroupPhotoGraphie(index);
	}
	...
	@Override
	public List<PhotoPhotoGraphy> selectPhotoGraphyByPage(int startIndex,
			int pageSize) {
		List<PhotoPhotoGraphy> list = photophotographyMapper.selectPhotoGraphyByPage(startIndex, pageSize);
		return list;
	}
